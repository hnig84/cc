...
public class SaveFrame extends JFrame {
	...
	public void init() {
		...
		String[] wordbook = {WordBookEnum.Blumen.name(), WordBookEnum.Geographie.name() };
		
		wordBookBox = new JComboBox<String>(wordbook);
		
		saveLavel = new JLabel("<html><center><h3>Wörterbuch</h3><br>neuen Eintrag hinzufügen</center></html>");
		JButton confirm = new JButton("Speichern");
		
		SaveListener sl = new SaveListener();
		confirm.addActionListener(sl);
		
		savePanel.add(saveLavel, BorderLayout.NORTH);
